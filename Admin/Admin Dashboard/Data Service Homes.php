...
if (isset($_GET['Id'])) {
    $id = $_GET['Id'];
    $delete = mysqli_query($conn, "DELETE FROM `service_homes` WHERE `Id`= '$id'");
    echo "<script>alert('Data Berhasil Dihapus');</script>";
    echo "<meta http-equiv='refresh' content='1;url= Data Service Homes.php'>";
}
?>
...
<head>
    ...
    <title>Data Service Homes</title>
</head>
        ...
        <section class="main">
            ...
            <section class="attendance">
                <div class="attendance-list">
                    <h2>Informasi Data Service Homes</h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['cari'])) {
                                ...
                                $search_query = "SELECT * FROM service_homes
                                ...
                                $count_query = "SELECT COUNT(*) AS total FROM service_homes
                                WHERE Nama LIKE '%$keyword%' 
                                OR Email LIKE '%$keyword%'
                                OR Alamat LIKE '%$keyword%' 
                                OR No_Kendaraan LIKE '%$keyword%'
                                ...
                                $search_query = "SELECT * FROM service_homes LIMIT $offset, $limit";
                                $count_query = "SELECT COUNT(*) AS total FROM service_homes";
                            }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="edit-btn"
                                            onclick="window.location.href='../Update/Update Data Service Homes.php?halaman=ubah_service&Id=<?php echo htmlspecialchars($pecah['Id']); ?>'">Edit</button>
                                        <button class="delete-btn"
                                            onclick="hapusServiceHomes(<?php echo $pecah['Id'] ?>)">Hapus</button>

                                        <script>
                                            function hapusServiceHomes(id) {
                                                // Konfirmasi penghapusan
                                                if (confirm('Apakah Anda yakin ingin menghapus Data ini?')) {
                                                    // Jika pengguna mengkonfirmasi, arahkan ke halaman hapus dengan ID yang sesuai
                                                    window.location.href = 'Data Service Homes.php?Id=' + id;
                                                }
                                            }
                                        </script>
                                    </td>
                    ...
                    <button class="add-btn" onclick="window.location.href='Data Service Now.php'">Service</button>
            </section>
        </section>
