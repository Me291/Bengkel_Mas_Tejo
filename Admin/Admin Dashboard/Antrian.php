...
if (isset($_GET['Id'])) {
    $id = $_GET['Id'];
    $delete = mysqli_query($conn, "DELETE FROM `input_table` WHERE `Id`= '$id'");
        ...
        <section class="main">
            ...
            <section class="attendance">
                <div class="attendance-list">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['cari'])) {
                                ...
                                $search_query = "SELECT * FROM input_table
                                WHERE Nama_Pemilik LIKE '%$keyword%' 
                                OR No_Kendaraan LIKE '%$keyword%'
                                OR No_Antrian LIKE '%$keyword%' 
                                OR Jenis_Motor LIKE '%$keyword%'
                                OR Status LIKE '%$keyword%'  
                                LIMIT $offset, $limit";

                                $count_query = "SELECT COUNT(*) AS total FROM input_table
                                 WHERE Nama_Pemilik LIKE '%$keyword%' 
                                OR No_Kendaraan LIKE '%$keyword%'
                                OR No_Antrian LIKE '%$keyword%' 
                                OR Jenis_Motor LIKE '%$keyword%'
                                ...
                                $search_query = "SELECT * FROM input_table LIMIT $offset, $limit";
                                $count_query = "SELECT COUNT(*) AS total FROM input_table";
                            }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="edit-btn"
                                            onclick="window.location.href='../Update/Update Table.php?halaman=update_table&Id=<?php echo htmlspecialchars($pecah['Id']); ?>'">Edit</button>
                                        <button class="delete-btn"
                                            onclick="hapusAntrian(<?php echo $pecah['Id'] ?>)">Hapus</button>
                                        ...
                                        <script>
                                            function hapusAntrian(id) {
                                                ...
                                                if (confirm('Apakah Anda yakin ingin menghapus Data ini?')) {
                                                    ...
                                                    window.location.href = 'Antrian.php?halaman=hapus%20Antrian&Id=' + id;
                                                }
                                            }
                                        </script>
                                    </td>
                    ...
                    <button class="add-btn" onclick="window.location.href='../Input/Input Data Antrian.php'">Tambah
                        Data</button>
            </section>
        </section>
